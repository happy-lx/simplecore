...
object RV64I 
{
    ...
    def SLLI =      BitPat("b000000??_????????_?001????_?0011011")
...
object RV64M
{
    def MUL =       BitPat("0000001?_????????_?000????_?0110011")
    def MULH =      BitPat("0000001?_????????_?001????_?0110011")
    def MULHSU =    BitPat("0000001?_????????_?010????_?0110011")
    def MULHU =     BitPat("0000001?_????????_?011????_?0110011")
    def MULW =      BitPat("0000001?_????????_?000????_?0111011")
    def REM  =      BitPat("0000001?_????????_?110????_?0110011")
    def REMU =      BitPat("0000001?_????????_?111????_?0110011")
    def REMUW =     BitPat("0000001?_????????_?111????_?0111011")
    def REMW =      BitPat("0000001?_????????_?110????_?0111011")
    def DIV =       BitPat("0000001?_????????_?100????_?0110011")
    def DIVU =      BitPat("0000001?_????????_?101????_?0110011")
    def DIVUW =     BitPat("0000001?_????????_?101????_?0111011")
    def DIVW =      BitPat("0000001?_????????_?100????_?0111011")
